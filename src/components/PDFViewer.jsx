...
export default function PDFViewer({ fileUrl }) {
  ...
  // Helper to get page width based on split mode
  const getPageWidth = () => {
  ...
  const maxPage = () => {
    ...
    // For double, last pair may be single page
  ...
  // Keep currentPage in bounds if numPages changes
  useEffect(() => {
    if (currentPage > maxPage()) setCurrentPage(maxPage());
  }, [numPages, layoutMode]);

  // Render page(s) for current view
  const renderPages = () => {
